...
//
//			// idDocumento = "FF14-32";
//			rutaComplta = ParametrosGLobales.obtenerParametros().getRutaRaiz();
...
//			try {
				...
				//
				// String entryName = ParametrosGLobales.obtenerParametros().getRutaRaiz() +
				// Constantes.rutaRespuesta + entry.getName();
				//
				...
				// Constantes.rutaRespuesta + "R-20553510661-01-FF14-32.xml");
				// File newfile = new File(ParametrosGLobales.obtenerParametros().getRutaRaiz()
				// + Constantes.rutaRespuesta + Constantes.siglaRespuesta
				...
				//
				// Document doc =
				// GestorArchivosXML.obtenerArchivoXML(ParametrosGLobales.obtenerParametros().getRutaRaiz()
				// + Constantes.rutaRespuesta
				// + Constantes.siglaRespuesta + Constantes.separadorNombreArchivo +
				// archivoXml);
				//
