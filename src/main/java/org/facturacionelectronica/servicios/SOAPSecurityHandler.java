	...
	public boolean handleMessage(final SOAPMessageContext msgCtx) {
		...
		if (outInd.booleanValue()) {
			try {
				...
				// userToken.addChildElement("Password", "wsse").addAttribute(new QName("Type"),
				// "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordText").addTextNode(password);
